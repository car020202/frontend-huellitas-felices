        ...
        <div className="container overlay-factura">
          ...
          <ul className="list-group lista-productos">
            {carrito.map((producto, index) => {
              ...
              return (
                <li key={index} className="list-group-item product-item mb-3 shadow-sm p-3 bg-white rounded">
                  <div className="product-content">
                    ...
                    <div className="product-info ms-3">
                      ...
                      <p className="text-muted mb-0">Precio: ${precio.toFixed(2)}</p>
          ...
          <div className="text-center mt-4">
            <PayPalScriptProvider options={{ "client-id": "AYx_hnrzeDEST-rreoNvzDGYRIDUio5Dg5zmJoop_Wsl0XRcS2geyHm62fx2yk5W8s4wrw5wFUMkfJBG" }}>
              <PayPalButtons
                createOrder={async () => {
                  try {
